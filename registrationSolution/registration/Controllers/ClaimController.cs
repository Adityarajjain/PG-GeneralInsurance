...
namespace registration.Controllers
{
    ...
    public class ClaimController : ApiController
    {
        ...
        //[HttpPost]
        //public void Post(MotorClaimDetailsTable motorclaim)
        //{
        //    entities.MotorClaimDetailsTables.Add(motorclaim);
        ...
        public HttpResponseMessage PostClaimAccident()
        {
            ...
            motorClaim.Policy_Id = Convert.ToInt64(httpRequest["Policy_Id"]);

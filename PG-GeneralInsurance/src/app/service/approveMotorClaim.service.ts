...
export class ApproveMotorClaimService {
  ...
  public rejectMotorClaim(Policy_id:number,amt:number,admin:string){
    return this.httpClient.put("http://localhost:53421/api/RejectMotorClaim?Policy_no="+Policy_id+"&amt="+amt+"&admin="+admin,'');
  }
}